...
class DashboardController extends Controller
{
    ...
    public function comprehensiveAnalytics(Request $request)
    {
        ...
        $vipCustomers = Sale::whereBetween('created_at', [$startDate, $endDate])
        ...
        $regularCustomers = Sale::whereBetween('created_at', [$startDate, $endDate])
            ...
            ->whereNotNull('customer_id')
            ->groupBy('customer_id')
            ->havingBetween('total_spent', [1000, 10000])
            ->count();

        $newCustomers = $totalCustomers - $vipCustomers - $regularCustomers;
