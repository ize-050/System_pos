            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">฿{{ formatPrice(statistics?.total_sales || 0) }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">฿{{ formatPrice(statistics?.today_sales || 0) }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">รายการวันนี้</p>
                            <p class="text-2xl font-bold text-gray-900">{{ statistics?.today_transactions || 0 }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-white">ประวัติการขาย</h1>
                        <p class="text-green-100 mt-1">จัดการและติดตามประวัติการขายทั้งหมด</p>
                    </div>
                    <Link
            ...
            <div v-if="sales.data.length > 0" class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="sale in sales.data" :key="sale.id" class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center mr-2">
                                        <span class="text-sm font-semibold text-purple-600">{{ sale.items_count }}</span>
                                    </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div v-if="sale.promotion" class="flex items-center">
                                    ...
                                    <div>
                                        <div class="text-sm font-medium text-gray-900">{{ sale.promotion.name }}</div>
                                        <div class="text-xs text-gray-500">{{ getPromotionTypeLabel(sale.promotion.type) }}</div>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium"
                                    ...
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path v-if="sale.payment_method === 'cash'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-xs text-gray-500">{{ formatTime(sale.created_at) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
            ...
            <div v-else class="text-center py-16">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">ไม่พบข้อมูลการขาย</h3>
                <p class="text-gray-500 mb-6">เริ่มต้นด้วยการสร้างรายการขายใหม่</p>
                <Link
                    :href="route('pos.index')"
            ...
            <!-- Pagination -->
            <div v-if="sales.data.length > 0" class="px-6 py-4 bg-gray-50 border-t border-gray-200">
