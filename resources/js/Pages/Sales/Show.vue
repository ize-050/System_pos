                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-900">{{ sale.cashier ? `${sale.cashier.first_name} ${sale.cashier.last_name}` : 'ไม่ระบุ' }}</p>
                                    </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div v-if="sale.promotion" class="flex justify-between">
                                        <span class="text-sm text-gray-600">โปรโมชั่น:</span>
                                        <span class="text-sm font-medium text-blue-600">{{ sale.promotion.name }}</span>
                                    </div>
        ...
        <div v-if="showEmailModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 w-96">
                ...
                <div class="flex justify-end gap-2">
                    <button @click="showEmailModal = false" class="px-4 py-2 bg-gray-300 rounded-md">ยกเลิก</button>
                    <button @click="sendEmail" class="px-4 py-2 bg-indigo-600 text-white rounded-md">ส่ง</button>
                </div>
            </div>
        </div>
    </AppLayout>
