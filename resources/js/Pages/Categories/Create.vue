<template>
  <AppLayout title="สร้างหมวดหมู่สินค้า">
    <template #header>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="mb-6 flex justify-between items-center">
              <h1 class="text-2xl font-bold text-gray-900">สร้างหมวดหมู่สินค้าใหม่</h1>
            ...
            <form @submit.prevent="submit" class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                  ...
                  <p class="mt-1 text-sm text-gray-500">ไม่บังคับ ให้คำอธิบายสั้นๆ เกี่ยวกับหมวดหมู่นี้</p>
                </div>
              </div>
              ...
              <div class="border-t pt-6">
                ...
                <p class="mt-1 text-sm text-gray-500">หมวดหมู่ที่ใช้งานจะสามารถใช้สำหรับกำหนดสินค้าได้</p>
              </div>

              <!-- Submit Buttons -->
              <div class="flex justify-end space-x-3 pt-6 border-t">
                <Link :href="route('categories.index')" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 active:bg-gray-500 focus:outline-none focus:border-gray-500 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                  ยกเลิก
                </Link>
                <button
                  type="submit"
